<%-- 
    Document   : Records
    Created on : mar 5, 2014, 9:34:18 p.m.
    Author     : Z
--%>
     ...
     //submit
      $(document).ready(function () {
       ...
       function callback(){    
           ...
           $.ajax({   
            url:"/json/xtats/recordsoverview.json",
            type: 'GET',
            data:{"startDate":init,"endDate":end, "textbox":nat, "states":st, "prefix":pref},
            dataType: 'json',
            beforeSend:function(){startAnimation();},
            success:function(datos){return DrawGraphicRecords(datos);},
            complete:function(){$("#loadingbar").fadeTo(1,0,$("#loadingbar").hide(0,0,stopAnimation()));}
      
        });
    }
        
        function DrawGraphicRecords(x){
