...
<script src="/js/displayTables.js"></script>
</head>
<body>
	<div id="main">
		<div class="sheet">
							...
							<div class="post">
								<div class="post-body">
									<div class="post-inner article">
										<c:if
											test="${contest != null and contest.initdate != null and (contest.past or contest.running or contest.coming)}">
													...
													<tbody>
														<tr>
															...
															<c:if test="${contest.running}">
																...
																<td><div class="elapsed"
																		data-time="${now.time - contest.initdate.time}"
																		data-limit="${contest.initdate.time}"></div></td>
																<td><b><spring:message
																			code="fieldhdr.remaining" /></b></td>
																<td><div class="remaining"
																		data-time="${contest.enddate.time - now.time}"
																		data-limit="${contest.enddate.time}"></div></td>
															</c:if>
