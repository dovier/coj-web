...
public interface ProblemDAO extends BaseDAO {
	...
	public void insertProblemClassification(Integer pid, Integer cid, Integer complexity);
	...
	public List<Problem> suggestedProblems(String language, List<UserProfile> knProfiles, UserProfile profile);

	public List<Problem> suggestedProblemsColdStart(String language, String userName, int uid);

	public List<Problem> suggestedProblems(String language, List<UserProfile> knProfiles, UserProfile profile, String pattern, int top, String sort, String direction, Integer classificationId,
			Integer complexity);

	public List<Problem> suggestedProblemsColdStart(String language, String username, String pattern, int top, String sort, String direction, int uid, Integer classificationId, Integer complexity);

	public IPaginatedList<Problem> findAllProblems(String language, String pattern, int found, PagingOptions options, String username, int i0, Integer filterby, Integer idClassification,
			Integer complexity);
