...
function Contestant(name){
   ...
   */
   this.penalty = 0;
   /**
      Actial amount of solved problems.
   */
   this.totalSolved = 0;
   /**
      Actial time of the last successful submission.
   */
...
function Contest(json){
   ...
   this.createFrozenStandings=function(){
      ...
      var standings = new Standings(cHash,this.getTimeBeforeFreeze());
      return standings;
   }
}

function Standings(cHash,limit){
   ...
   this.goNext = function(){
      ...
      if (this.flashActive){
         ...
         for (var pName in contestant.runInfoHash){
            var runInfo = contestant.runInfoHash[pName];
...
function createTemplateRow(idx){
  $('#standings-table').append('<div class="element" id="'+idx+'" style=" z-index:0"><table class="contestant-info"><tr><td><div class="contestant"></div></td></tr><tr style="top 50px;"><td><table class="problems-list"><tr><td class="info"><div class="info-caption">place</div><div class="info-text" id="place">0</div></td><td class="problem"><div class="problem-caption">&nbsp;</div><div class="problem-result" id="no-submitions">.</div></td><td class="info"><div class="info-caption">Problems</div><div class="info-text" id="totalSolved">0</div></td><td class="info"><div class="info-caption">penalty</div><div class="info-text" id="penalty">0</div></td></tr></table></td></tr></table></div>');  
...
function moveRow(idx,delta){
   if (delta>0){
      getRow(idx).css('z-index','1').animate({top:'-='+(rowHeight*delta)+''},2000,'jswing',function(){  getRow(idx).css('z-index','0')});
   }else{
...
function load(contestLog){
   $('#inner #show-log').click(JSONLogPanelControl);
         ...
         var contest
            var json = eval(contestLog);
            contest = new Contest(json);
