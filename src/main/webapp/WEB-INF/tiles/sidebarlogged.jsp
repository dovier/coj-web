			...
			<div>
				<ul class="list-unstyled">
					<authz:authorize
						...
						<li><a href="<c:url value="/admin/index.xhtml"/>"><i
					...
					<li><a href="<c:url value="/user/updateaccount.xhtml" />"><i
					...
					<authz:authorize ifAnyGranted="ROLE_USER">
						<li><a href="<c:url value="/mail/inbox.xhtml?start=1"/>"><i
								class="fa fa-envelope"></i>&nbsp;<spring:message
									code="link.mail" /></a>
							<ul>
								<li><a href="<c:url value="/mail/inbox.xhtml?start=1"/>">
								...
								<li><a href="<c:url value="/mail/outbox.xhtml?start=1"/>"><i
										class="fa fa-send"></i>&nbsp;<spring:message code="link.sent" />
								</a></li>
								<li><a href="<c:url value="/mail/draft.xhtml"/>"><i
										class="fa fa-envelope-o"></i>&nbsp;<spring:message
											code="link.drafts" /> <c:if test="${drafts ne 0}">
											<span class="label label-default">(${drafts})</span>
										</c:if> </a></li>
							</ul></li>
					</authz:authorize>
