                ...
                <form action="<c:url value="/j_spring_security_check"/>"
                    ...
                    <div class="margin-top-05 form-group">
                        <div class="input-group">
                            ...
                            <c:if test="${not empty param.login_error}">
                                <input class="form-control" placeholder="<spring:message code="fieldhdr.usermail"/>"
                                       type='text'
                        ...
                        <div class="input-group">
									<span class="input-group-addon"><i
                                            class="fa fa-ellipsis-h"></i></span> <input class="form-control"
                                                                                        placeholder="<spring:message code="fieldhdr.password"/>"
                                                                                        name="j_password" size="17"
                                                                                        type="password">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <br>
                    <a href="<c:url value="/general/tos.xhtml"/>"><i
                            class="fa fa-check"></i> <spring:message code="fieldhdr.agreementcojtos.menu"/></a>
