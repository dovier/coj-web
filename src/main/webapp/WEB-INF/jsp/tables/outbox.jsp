...
<display:table id="mail" name="mails" class="volume" requestURI=""
	...
	<display:column property="to" titleKey="tablehdr.to"
		headerClass="headfrom" />
	<display:column property="title" titleKey="tablehdr.subject"
		href="mailview.xhtml?idmail=0" paramId="send" paramProperty="idmail" />
	...
	<display:column titleKey="tablehdr.delete">
		<a href="<c:url value="deletemail.xhtml?send=${mail.idmail}"/>"
