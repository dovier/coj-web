<%-- 
    Document   : problemsubmitions
    Created on : mar 15, 2014, 10:52:22 a.m.
    Author     : Z
--%>
      ...
      $(document).ready(function () {
        ...
        function callback(){          
          ...
          var pid2=$('#textbox2').val();
            $.ajax({
            url:"/json/xtats/problemsubmit.json",
            type: 'GET',
            data:{"textbox1":pid1, "startDate":init,"endDate":end, "textbox":nat, "states":st},
            dataType: 'json',
        ...
        function drawBarChartStatesProblems(x){
				...
				header: {
					text: "Problems Submitions's Chart"
				},
				seriesList: [{
					label: "Problem #1",
					legendEntry: false,
