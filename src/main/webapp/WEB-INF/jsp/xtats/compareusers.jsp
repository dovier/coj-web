<%-- 
    Document   : compareusers
    Created on : abr 24, 2014, 10:49:49 a.m.
    Author     : Z
--%>
...
<div class="main demo">
    <input id="states" style="width: 150px"/>  
        </div> 
    ...
    //submit
      $(document).ready(function () {            
        ...
        function callback(){          
          ...
          var end=$("#endDate").val();
          var nat=parseInt($('#textbox').val());
          var st=$('#states').val();
          var pid1=$('#textbox1').val();
          var pid2=$('#textbox2').val();
          alert(nat); alert(st);
            $.ajax({
            url:"/json/xtats/userscompare.json",
            type: 'GET',
            data:{"textbox1":pid1, "textbox2":pid2, "textbox":nat, "states":st, "startDate":init,"endDate":end},
            dataType: 'json',
            success:function (datos){return drawBarChartCompareUsers(datos);}
                  
        });
        }
        
        function drawBarChartCompareUsers(x){
                alert(x);
