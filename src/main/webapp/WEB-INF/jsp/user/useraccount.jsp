                    ...
                    <c:if test="${user.team == false}">
                        <div class="col-xs-2">
                            <div class="avatar_preview">
                                ...
                                <img alt="avatar" class="avatar img-responsive" data-toggle="tooltip"
                                     title="${user.username}"
                                ...
                                <c:forEach items="${solved}" var="problem">
                                    <div class="col-xs-1 margin-top-05">
                                        <a
                                                ...
                                                title="${problem.title}"><span
                                                class="badge alert-success">${problem.pid}</span></a>
                                    </div>
                                </c:forEach>
                            </div>
                        </div>
                                ...
                                <c:forEach items="${unsolved}" var="problem">
                                    <div class="col-xs-1 margin-top-05">
                                        <a
                                                ...
                                                title="${problem.title}"><span
                                                class="badge alert-danger">${problem.pid}</span></a>
                                    </div>
                                </c:forEach>
                            </div>
                        </div>
