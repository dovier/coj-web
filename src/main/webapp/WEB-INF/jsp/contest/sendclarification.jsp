            ...
            <tr>
                ...
                <td>
                    <select class="form-control" name="modes">
                        <option value="4"><spring:message code="fieldval.customized"/></option>
                        <option value="1"><spring:message code="fieldval.nocomments"/></option>
                        <option value="2"><spring:message code="fieldval.yes"/></option>
