...
<h2 class="postheader">
   <spring:message code="pagehdr.24h"/>: <spring:message code="pagehdr.compileinfo"/>
</h2>
<div class="postcontent">    
    <div><textarea cols="" rows=""  id="code" style="height: 410px;width: 100%;text-align: justify;"><c:out value="${info}"/></textarea></div>
</div>
