...
<div class="postcontent">
            ...
            <fieldset style="width: 400px;">
                <table class="contestlanguages">
                    <tr>
                        ...
                        <td><form:input path="guestGroup" cssClass="form-control" /></td>
                    </tr>
                    <tr>
                        <td colspan="2"><fmt:message key="page.managecontest.group" />:</td>
                        <td><form:input path="groupd" cssClass="form-control" /></td>
                    </tr>
                </table>
            </fieldset>
        </c:if>
            ...
            <c:choose>
                ...
                <c:when test="${contest.registration eq 2}">
                    <tr>
                        ...
                        <td rowspan="2"><input id="search-btusers" cssClass="form-control" /><form:select path="" id="bt_allusers"
                                     size="14" cssClass="login form-control"
                                     cssStyle="width: 310px; border: 1px solid #577A5A;"
                                     multiple="true">
    ...
    <div class="coj_float_rigth">
        <a href="#" onclick="confirm_delete('<c:url value="deleteusercontest.xhtml?all=true&cid=${contest.cid}"/>')"><i
    ...
    <table class="table table-condensed table-striped">
        ...
        <c:forEach items="${contest.users}" var="user">
            ...
            <tr>
                <td><div align="center"><a href="manageuser.xhtml?username=${user.username}">${user.username}</a></div></td>
                <td><div align="center">${user.nick}</div></td>

                <td><div align="center">${user.group}</div></td>
                <td><div align="center"> <a onclick="confirm_delete('<c:url value="deleteusercontest.xhtml?uid=${user.uid}&cid=${contest.cid}"/>')"
