...
<div class="postcontent">
    ...
    <form id="filter-form" class="form-inline">
        <div class="form-group coj_float_rigth">
            <input
                type="text" placeholder="<fmt:message key="page.general.admin.usersearch" />" name="pattern" value="${pattern}" class="form-control" /> 
            <input id="filter-button" type="submit" class="btn btn-primary"
                   value="<spring:message code="button.filter"/>">
        </div>
        <div class="form-group coj_float_left">	
            <a class="btn btn-primary" href="<c:url value="/admin/createteams.xhtml" />"><spring:message code="fieldhdr.addteams"/></a>
        </div>
