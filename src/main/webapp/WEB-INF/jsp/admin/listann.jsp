...
<h2 class="postheader">
    <spring:message code="page.general.admin.header"/>: <spring:message code="pagehdr.amannouncements"/>
</h2>
    ...
    <form id="filter-form" class="form-inline">
        <div id="form-group">
            ...
            <div class="coj_float_rigth">
                <input type="text" placeholder="<spring:message code="filedhdr.searchcontent" />" class="form-control"
