...
public class Respuesta3Encuesta_Test {
   ...
   private Utiles_TestAdministracionEncuesta utiles_testAdministracionEncuesta;
    ...
    //Validando respuesta3
    @Test
    public void validarRespuesta3() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionEncuesta.getRespuesta3CorrectosEncuesta();
        ArrayList<String> lista2 = utiles_testAdministracionEncuesta.getRespuesta3IncorrectosEncuesta();
       ...
       String direccionAux="/admin/poll/manage.xhtml?pid="+ utiles_testAdministracionEncuesta.getIdEncuesta();
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de respuesta 23 incorrecta", "/admin/poll/list.xhtml",o );
        }
        ...
        for (String a : lista2) {
            r = mockMvc.perform(post(direccionAux)
                    ...
                    .session((MockHttpSession) result.getRequest().getSession()))
                    .andReturn();
            Assert.assertEquals("Validacion de respuesta 3 incorrecta", null, r.getResponse().getRedirectedUrl());
