...
public class Respuesta1Encuesta_Test {
   ...
   private Utiles_TestAdministracionEncuesta utiles_testAdministracionEncuesta;
    ...
    //Validando respuesta1
    @Test
    public void validarRespuesta1() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionEncuesta.getRespuesta1CorrectosEncuesta();
        ArrayList<String> lista2 = utiles_testAdministracionEncuesta.getRespuesta1IncorrectosEncuesta();
       ...
       String direccionAux="/admin/poll/manage.xhtml?pid="+ utiles_testAdministracionEncuesta.getIdEncuesta();
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de respuesta 1 incorrecta", "/admin/poll/list.xhtml",o );
        }
        ...
        for (String a : lista2) {
            ...
            Assert.assertEquals("Validacion de respuesta 1 incorrecta", null, r.getResponse().getRedirectedUrl());
