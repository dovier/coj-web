...
public class SitioWebInstitucion_Test {
    ...
    //Validando sitio web de institucion
    @Test
    public void validarSitioWebInstitucion() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionInstitucion.getSitioWebcorrectasInstitucion();
        ArrayList<String> lista2 = utiles_testAdministracionInstitucion.getSitioWebIncorrectasInstitucion();
        ...
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de sitio web de institucion incorrecta", "/admin/manageinstitutions.xhtml?pattern="+utiles_testAdministracionInstitucion.getNombreCorrecto(),o1 );
        }
        ...
        for (String a : lista2) {
            ...
            Assert.assertEquals("Validacion de sitio web de institucion incorrecta", null, o2);
