...
public class CodigoInstitucion_Test {
    ...
    //Validando codigo de institucion
    @Test
    public void validarCodigoInstitucion() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionInstitucion.getCodigoCorrectasInstitucion();
        ArrayList<String> lista2 = utiles_testAdministracionInstitucion.getCodigosIncorrectasInstitucion();
        ...
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de codigo de institucion incorrecta", "/admin/manageinstitutions.xhtml?pattern="+utiles_testAdministracionInstitucion.getNombreCorrecto(),o1 );
        }
        ...
        for (String a : lista2) {
            ...
            Assert.assertEquals("Validacion de codigo de institucion incorrecta", null, o2);
