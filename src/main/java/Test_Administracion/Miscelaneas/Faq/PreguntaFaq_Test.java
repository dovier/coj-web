...
import Test_Administracion.Miscelaneas.LenguajeProgramacion.Utiles_TestAdministracionLenguajeProgramacion;
...
public class PreguntaFaq_Test {
   ...
   private Utiles_TestAdministracionFaq utiles_testAdministracionFaq;
    ...
    public void validarPregunta() throws Exception {
        ...
        ArrayList<String> lista1 = utiles_testAdministracionFaq.getPreguntasCorrectosFaq();
        ArrayList<String> lista2 = utiles_testAdministracionFaq.getPreguntasIncorrectosFaq();
       ...
       String direccionAux="/admin/editfaq.xhtml?id="+ utiles_testAdministracionFaq.getIdFaq();
        for (String a : lista1) {
            r = mockMvc.perform(post(direccionAux)
                    .param("question", a)
                    .param("answer", utiles_testAdministracionFaq.getRespuestaCorrecta())
                    .session((MockHttpSession) result.getRequest().getSession()))
                    .andReturn();

            Object o =new Object();
            o=r.getResponse().getRedirectedUrl();
            Assert.assertEquals("Validacion de pregunta incorrecta", "/admin/faqs.xhtml",o );
        }
