...
public class NombreBinLenguajeProgramacion_Test {
   ...
   private Utiles_TestAdministracionLenguajeProgramacion utilesTestAdministracionLenguajeProgramacion;
    ...
    //Validando nombre bin
    @Test
    public void validarNombreBin() throws Exception {

        ArrayList<String> lista1 = utilesTestAdministracionLenguajeProgramacion.getNombreBinCorrectosLenguajeProgramacion();
        ArrayList<String> lista2 = utilesTestAdministracionLenguajeProgramacion.getNombreBinIncorrectosLenguajeProgramacion();
       ...
       String direccionAux="/admin/managelanguage.xhtml?lid="+ utilesTestAdministracionLenguajeProgramacion.getIdLenguajeProgramacion();
        for (String a : lista1) {
            r = mockMvc.perform(post(direccionAux)
                    ...
                    .param("key",utilesTestAdministracionLenguajeProgramacion.getDescripcionCorrecta() )
                    .param("descripcion", utilesTestAdministracionLenguajeProgramacion.getNombreBinCorrecto())
                    .param("name_bin", a)
            ...
            Assert.assertEquals("Validacion de nombre de bin incorrecta", "/admin/programminglanguages.xhtml",o );
        }
        ...
        for (String a : lista2) {
            ...
            Assert.assertEquals("Validacion de nombre de bin incorrecta", null, r.getResponse().getRedirectedUrl());
