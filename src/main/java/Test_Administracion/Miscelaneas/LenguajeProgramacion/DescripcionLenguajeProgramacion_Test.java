...
public class DescripcionLenguajeProgramacion_Test {
   ...
   private Utiles_TestAdministracionLenguajeProgramacion utilesTestAdministracionLenguajeProgramacion;
    ...
    @Test
    public void validarDescripcion() throws Exception {

        ArrayList<String> lista1 = utilesTestAdministracionLenguajeProgramacion.getDescripcionCorrectosLenguajeProgramacion();
        ArrayList<String> lista2 = utilesTestAdministracionLenguajeProgramacion.getDescripcionIncorrectosLenguajeProgramacion();
       ...
       String direccionAux="/admin/managelanguage.xhtml?lid="+ utilesTestAdministracionLenguajeProgramacion.getIdLenguajeProgramacion();
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de descripcion incorrecta", "/admin/programminglanguages.xhtml",o );
        }
        ...
        for (String a : lista2) {
            ...
            Assert.assertEquals("Validacion de descripcion incorrecta", null, r.getResponse().getRedirectedUrl());
