...
public class LenguajeLenguajeProgramacion_Test {
   ...
   private Utiles_TestAdministracionLenguajeProgramacion utilesTestAdministracionLenguajeProgramacion;
    ...
    //Validando lenguaje
    @Test
    public void validarLenguaje() throws Exception {

        ArrayList<String> lista1 = utilesTestAdministracionLenguajeProgramacion.getLenguajesCorrectosLenguajeProgramacion();
        ArrayList<String> lista2 = utilesTestAdministracionLenguajeProgramacion.getLenguajesIncorrectosLenguajeProgramacion();
       ...
       String direccionAux="/admin/managelanguage.xhtml?lid="+ utilesTestAdministracionLenguajeProgramacion.getIdLenguajeProgramacion();
        for (String a : lista1) {
            r = mockMvc.perform(post(direccionAux)
                    .param("language", a)
                    .param("key", utilesTestAdministracionLenguajeProgramacion.getLlaveCorrecta())
            ...
            Assert.assertEquals("Validacion de lenguaje incorrecta", "/admin/programminglanguages.xhtml",o );
        }
        ...
        for (String a : lista2) {
            ...
            Assert.assertEquals("Validacion de lenguaje incorrecta", null, r.getResponse().getRedirectedUrl());
