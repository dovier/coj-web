...
public class Codigo3Pais_Test {
   ...
   private Utiles_TestAdministracionPais utiles_testAdministracionPais;
    ...
    //Validando codigo 3
    @Test
    public void validarCodigo3() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionPais.getCodigos3CorrectosPais();
        ArrayList<String> lista2 = utiles_testAdministracionPais.getCodigos3IncorrectosPais();
     ...
     for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de codigo 3 incorrecta", "/admin/managecountries.xhtml",o );
        }
        ...
        for (String a : lista2) {
            ...
            Object o =new Object();
            o=r.getResponse().getRedirectedUrl();
            Assert.assertEquals("Validacion de codigo 3 incorrecta", null, o);
