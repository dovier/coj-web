...
public class SitioWebPais_Test {
   ...
   private Utiles_TestAdministracionPais utiles_testAdministracionPais;
    ...
    //Validando sitio web
    @Test
    public void validarSitioWeb() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionPais.getSitioCorrectosPais();
        ArrayList<String> lista2 = utiles_testAdministracionPais.getSitioIncorrectosPais();
     ...
     for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de sitio web incorrecta", "/admin/managecountries.xhtml",o );
        }
        ...
        for (String a : lista2) {
            ...
            Object o =new Object();
            o=r.getResponse().getRedirectedUrl();
            Assert.assertEquals("Validacion de sitio web incorrecta", null, o);
