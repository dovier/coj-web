...
public class NombreFuente_Test {
   ...
   private Utiles_TestAdministracionFuentes utiles_testAdministracionFuentes;
    ...
    //Validando fuente
    @Test
    public void validarFuenteFuente() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionFuentes.getFuenteCorrectosFuente();
        ArrayList<String> lista2 = utiles_testAdministracionFuentes.getFuenteIncorrectosFuente();
       ...
       String direccionAux="/admin/updatesource.xhtml";
        for (String a : lista1) {
            r = mockMvc.perform(post(direccionAux)
                    ...
                    .param("name", a)
                    .param("author", utiles_testAdministracionFuentes.getAutorIncorrecta())
            ...
            Assert.assertEquals("Validacion de fuente incorrecta", "/admin/managesources.xhtml",o );
        }
        ...
        for (String a : lista2) {
            ...
            Assert.assertEquals("Validacion de fuente incorrecta", null, r.getResponse().getRedirectedUrl());
