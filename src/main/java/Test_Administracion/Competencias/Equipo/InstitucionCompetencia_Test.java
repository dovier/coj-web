...
public class InstitucionCompetencia_Test {
   ...
   private Utiles_TestAdministracionEquipo utiles_testAdministracionEquipo;
    ...
    //Validando institucion
    @Test
    public void validarInstitucion() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionEquipo.getInstitucionsCorrectosEquipo();
        ArrayList<String> lista2 = utiles_testAdministracionEquipo.getInstitucionIncorrectosEquipo();
       ...
       String direccionAux="/admin/createteams.xhtml";
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de institucion incorrecta", "/admin/manageteams.xhtml",o );
        }
        ...
        for (String a : lista2) {
            ...
            Object o =new Object();
            o=r.getResponse().getRedirectedUrl();
            Assert.assertEquals("Validacion de institucion incorrecta", null, o);
