...
public class UserNameCompetencia_Test {
   ...
   private Utiles_TestAdministracionEquipo utiles_testAdministracionEquipo;
    ...
    //Validando nobre de ususario
    @Test
    public void validarNombreUsuario() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionEquipo.getUserNameCorrectosEquipo();
        ArrayList<String> lista2 = utiles_testAdministracionEquipo.getUserNameIncorrectosEquipo();
       ...
       String direccionAux="/admin/createteams.xhtml";
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de nombre de usuario incorrecta", "/admin/manageteams.xhtml",o );
        }
        ...
        for (String a : lista2) {
            ...
            Object o =new Object();
            o=r.getResponse().getRedirectedUrl();
            Assert.assertEquals("Validacion de nombre de usuario incorrecta", null, o);
