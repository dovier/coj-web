...
public class PaisCompetencia_Test {
   ...
   private Utiles_TestAdministracionEquipo utiles_testAdministracionEquipo;
    ...
    public void validarPais() throws Exception {
        ...
        ArrayList<String> lista1 = utiles_testAdministracionEquipo.getPaisCorrectosEquipo();
        ArrayList<String> lista2 = utiles_testAdministracionEquipo.getPaisIncorrectosEquipo();
       ...
       String direccionAux="/admin/createteams.xhtml";
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de pais incorrecta", "/admin/manageteams.xhtml",o );
        }
        ...
        for (String a : lista2) {
            ...
            Object o =new Object();
            o=r.getResponse().getRedirectedUrl();
            Assert.assertEquals("Validacion de pais incorrecta", null, o);
