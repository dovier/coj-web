...
public class ContrasennasCompetencia_Test {
   ...
   private Utiles_TestAdministracionEquipo utiles_testAdministracionEquipo;
    ...
    //Validando contrasennas
    @Test
    public void validarCcontrasenna() throws Exception {

        ArrayList<ArrayList<String>> lista1 = utiles_testAdministracionEquipo.getContrasennasCorrectosEquipo();
        ArrayList<ArrayList<String>> lista2 = utiles_testAdministracionEquipo.getContrasennasIncorrectosEquipo();
       ...
       String direccionAux="/admin/createteams.xhtml";
        for (ArrayList<String> a : lista1) {
            r = mockMvc.perform(post(direccionAux)
                      ...
                      .param("password", a.get(0))
                      .param("confirmPassword", a.get(1))
                      ...
                      .param("locale", utiles_testAdministracionEquipo.getIdiomaCorrecto())
            ...
            Assert.assertEquals("Validacion de contrasennas incorrecta", "/admin/manageteams.xhtml",o );
        }
        ...
        for (ArrayList<String> a :lista2) {
            ...
            Object o =new Object();
            o=r.getResponse().getRedirectedUrl();
            Assert.assertEquals("Validacion de contrasennas incorrecta", null, o);
