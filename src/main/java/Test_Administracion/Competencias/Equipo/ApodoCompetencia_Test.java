...
public class ApodoCompetencia_Test {
   ...
   private Utiles_TestAdministracionEquipo utiles_testAdministracionEquipo;
    ...
    //Validando apodo
    @Test
    public void validarApodo() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionEquipo.getApodoCorrectosEquipo();
        ArrayList<String> lista2 = utiles_testAdministracionEquipo.getApodoIncorrectosEquipo();
       ...
       String direccionAux="/admin/createteams.xhtml";
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de apodo incorrecta", "/admin/manageteams.xhtml",o );
        }
        ...
        for (String a : lista2) {
            ...
            Object o =new Object();
            o=r.getResponse().getRedirectedUrl();
            Assert.assertEquals("Validacion de apodo incorrecta", null, o);
