...
public class TotalCompetencia_Test {
   ...
   private Utiles_TestAdministracionEquipo utiles_testAdministracionEquipo;
    ...
    public void validarTotal() throws Exception {
        ...
        ArrayList<String> lista1 = utiles_testAdministracionEquipo.getTotalCorrectosEquipo();
        ArrayList<String> lista2 = utiles_testAdministracionEquipo.getTotalIncorrectosEquipo();
       ...
       String direccionAux="/admin/createteams.xhtml";
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de total incorrecta", "/admin/manageteams.xhtml",o );
        }
        ...
        for (String a : lista2) {
            ...
            Object o =new Object();
            o=r.getResponse().getRedirectedUrl();
            Assert.assertEquals("Validacion de total incorrecta", null, o);
