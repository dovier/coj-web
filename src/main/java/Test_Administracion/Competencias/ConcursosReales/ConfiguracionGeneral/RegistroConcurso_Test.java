...
public class RegistroConcurso_Test {
   ...
   private Utiles_TestAdministracionConursoR utiles_testAdministracionConursoR;
    ...
    public void validarRegistro() throws Exception {
        ...
        ArrayList<String> lista1 = utiles_testAdministracionConursoR.getRegistrosCorrectosConcurso();
        ArrayList<String> lista2 = utiles_testAdministracionConursoR.getRegistrosIncorrectosConcurso();
       ...
       String direccionAux="/admin/managecontest.xhtml?cid="+ utiles_testAdministracionConursoR.getIdConcurso();
        ...
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de registro incorrecta", direccionAux,o );
        }
        ...
        for (String a : lista2) {
            ...
            Object o =new Object();
            o=r.getResponse().getRedirectedUrl();
            Assert.assertEquals("Validacion de registro incorrecta", null,o);
