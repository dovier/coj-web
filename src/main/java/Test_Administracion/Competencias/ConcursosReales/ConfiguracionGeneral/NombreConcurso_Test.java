...
public class NombreConcurso_Test {
   ...
   private Utiles_TestAdministracionConursoR utiles_testAdministracionConursoR;
    ...
    public void validarNombre() throws Exception {
        ...
        ArrayList<String> lista1 = utiles_testAdministracionConursoR.getNombresCorrectosConcurso();
        ArrayList<String> lista2 = utiles_testAdministracionConursoR.getNombresIncorrectosConcurso();
       ...
       String direccionAux="/admin/managecontest.xhtml?cid="+ utiles_testAdministracionConursoR.getIdConcurso();
        ...
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de nombre incorrecta", direccionAux,o );
        }
