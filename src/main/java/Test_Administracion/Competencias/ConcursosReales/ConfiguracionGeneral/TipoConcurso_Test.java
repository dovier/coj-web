...
public class TipoConcurso_Test {
   ...
   private Utiles_TestAdministracionConursoR utiles_testAdministracionConursoR;
    ...
    //Validando tipo de concurso
    @Test
    public void validarTipoConcurso() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionConursoR.getTipoCorrectosConcurso();
        ArrayList<String> lista2 = utiles_testAdministracionConursoR.getTipoIncorrectosConcurso();
       ...
       String direccionAux="/admin/managecontest.xhtml?cid="+ utiles_testAdministracionConursoR.getIdConcurso();
        ...
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de tipo de concurso incorrecta", direccionAux,o );
        }
        ...
        for (String a : lista2) {
            ...
            Object o =new Object();
            o=r.getResponse().getRedirectedUrl();
            Assert.assertEquals("Validacion de tipo de concurso incorrecta", null,o);
