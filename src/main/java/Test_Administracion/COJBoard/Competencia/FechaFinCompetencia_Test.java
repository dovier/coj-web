...
public class FechaFinCompetencia_Test {
   ...
   private Utiles_TestAdministracionCompetencia utiles_testAdministracionCompetencia;
    ...
    //Validando fecha de fin de competencia
    @Test
    public void validarFechaFinCompetencia() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionCompetencia.getFechaFincorrectasCompetencia();
        ArrayList<String> lista2 = utiles_testAdministracionCompetencia.getFechaFinincorrectasCompetencia();
        ...
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de fecha de fin incorrecta", "/admin/wboard/contest/list.xhtml",o );
        }
        ...
        for (String a : lista2) {
            ...
            Assert.assertEquals("Validacion de fecha de fin incorrecta", null, r.getResponse().getRedirectedUrl());
