...
public class UrlCompetencia_Test {
   ...
   private Utiles_TestAdministracionCompetencia utiles_testAdministracionCompetencia;
    ...
    //Validando url de competencia
    @Test
    public void validarUrlCompetencia() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionCompetencia.getUrlscorrectasCompetencia();
        ArrayList<String> lista2 = utiles_testAdministracionCompetencia.getUrlsincorrectasCompetencia();
        ...
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de url incorrecta", "/admin/wboard/contest/list.xhtml",o1 );
        ...
        for (String a : lista2) {
            ...
            Assert.assertEquals("Validacion de seleccionar url incorrecta", null, o2);
