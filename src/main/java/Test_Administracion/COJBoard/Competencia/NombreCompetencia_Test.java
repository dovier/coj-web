...
public class NombreCompetencia_Test {
   ...
   private Utiles_TestAdministracionCompetencia utiles_testAdministracionCompetencia;
    ...
    //Validando nombre
    @Test
    public void validarNombreCompetencia() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionCompetencia.getNombresCorrectosCompetencia();
        ArrayList<String> lista2 = utiles_testAdministracionCompetencia.getNombresIncorrectosCompetencia();
       ...
       String direccionAux="/admin/wboard/contest/edit.xhtml?id="+ utiles_testAdministracionCompetencia.getIdCOmpetencia();
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de nombre incorrecta", "/admin/wboard/contest/list.xhtml",o );
        }
        ...
        for (String a : lista2) {
            ...
            Assert.assertEquals("Validacion de nombre incorrecta", null, r.getResponse().getRedirectedUrl());
