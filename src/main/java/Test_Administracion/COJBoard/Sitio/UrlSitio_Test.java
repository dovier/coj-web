...
public class UrlSitio_Test {
    ...
    //Validando url de sitio
    @Test
    public void validarUrlSitio() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionSitio.getUrlscorrectasSitio();
        ArrayList<String> lista2 = utiles_testAdministracionSitio.getUrlsincorrectasSitio();
        ...
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de url de sitio incorrecta", "/admin/wboard/site/list.xhtml",o1 );
        }
        ...
        for (String a : lista2) {
            ...
            Assert.assertEquals("Validacion de url de sitio incorrecta", null, o2);
