...
public class ZonaHorariaSitio_Test {
    ...
    //Validando zona horaria de sitio
    @Test
    public void validarIDHoraFechaSitio() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionSitio.getZonaHorariaCorrectaCompetencia();
        ArrayList<String> lista2 = utiles_testAdministracionSitio.getZonaHorariaIncorrectaCompetencia();
        ...
        for (String a : lista1) {
            ...
            r = mockMvc.perform(post("/admin/wboard/site/edit.xhtml")
                    .param("site", utiles_testAdministracionSitio.getNombreCorrecto())
            ...
            Assert.assertEquals("Validacion de zona horaria de sitio incorrecta", "/admin/wboard/site/list.xhtml",o1 );
            }
           else
            {
                Assert.assertEquals("Validacion de zona horaria de sitio incorrecta", "/admin/wboard/site/list.xhtml",null );
            }
        }
        ...
        for (String a : lista2) {
            ...
            Assert.assertEquals("Validacion de zona horaria de sitio incorrecta", null, o2);
