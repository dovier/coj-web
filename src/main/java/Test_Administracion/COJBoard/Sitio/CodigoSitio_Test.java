...
public class CodigoSitio_Test {
    ...
    //Validando codigo de sitio
    @Test
    public void validarCodigoSitio() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionSitio.getCodigocorrectoSitio();
        ArrayList<String> lista2 = utiles_testAdministracionSitio.getCodigoIncorrectoSitio();
        ...
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de codigo de sitio incorrecta", "/admin/wboard/site/list.xhtml",o1 );
        }
        ...
        for (String a : lista2) {
            ...
            Assert.assertEquals("Validacion de codigo de sitio incorrecta", null, o2);
