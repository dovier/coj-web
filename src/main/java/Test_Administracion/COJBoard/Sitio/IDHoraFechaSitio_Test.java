...
public class IDHoraFechaSitio_Test {
    ...
    //Validando id de hora y fecha de sitio
    @Test
    public void validarIDHoraFechaSitio() throws Exception {

        ArrayList<String> lista1 = utiles_testAdministracionSitio.getIdHoraFechacorrectasSitio();
        ArrayList<String> lista2 = utiles_testAdministracionSitio.getIdHoraFechaIncorrectasSitio();
        ...
        for (String a : lista1) {
            ...
            Assert.assertEquals("Validacion de id de hora y fecha de sitio incorrecta", "/admin/wboard/site/list.xhtml",o1 );
        }
        ...
        for (String a : lista2) {
            ...
            Assert.assertEquals("Validacion de id de hora y fecha de sitio incorrecta", null, o2);
