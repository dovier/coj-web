...
public class Roles {
	...
	public static final String[] ROLE_ADMIN_LIST = new String[] {
			...
			Roles.ROLE_JUDGE, Roles.ROLE_FILE_MANAGER, Roles.ROLE_USER };
	@Deprecated
	public static final String[] ROLE_SUPER_PSETTER_LIST = new String[] {
			Roles.ROLE_SUPER_PSETTER, Roles.ROLE_PSETTER, Roles.ROLE_JUDGE,
	...
	@Deprecated
	public static final String[] ROLE_JUDGE_LIST = new String[] {
			Roles.ROLE_JUDGE, Roles.ROLE_USER };
	@Deprecated
