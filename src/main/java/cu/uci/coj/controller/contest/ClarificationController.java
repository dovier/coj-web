...
public class ClarificationController extends BaseController {
	...
	public String SendClarification(Locale locale, Model model, Principal principal, Clarification clarification, BindingResult result, @RequestParam("modes") Integer mode) {
		clarification.setTitle("");
		switch (mode) {
		case 1: {
