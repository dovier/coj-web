...
public class EntryController extends BaseController {
    ...
    public
    @ResponseBody
    String like(Principal principal, @RequestParam Integer id, Model model, PagingOptions options) {
    ...
    public
    @ResponseBody
    String dislike(Principal principal, @RequestParam Integer id, Model model, PagingOptions options) {
    ...
    public
    @ResponseBody
    Entry disableEntry(HttpServletRequest request, Locale locale, Principal principal, @RequestParam Integer id) {
        if (request.isUserInRole(Roles.ROLE_ADMIN)) {
