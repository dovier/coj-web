...
public class WbBoardAdminController extends BaseController {
    ...
    public String createSitePost(Model model, WbSite wbSite, BindingResult result, RedirectAttributes redirectAttributes) {
    ...
    public String deleteSite(Model model, @RequestParam("sid") Integer sid, RedirectAttributes redirectAttributes) {
        try {
    ...
    public String createContestPost(Model model, WbContest wbContest, BindingResult result, RedirectAttributes redirectAttributes) {
    ...
    public String editContestPost(Model model, WbContest wbContest, BindingResult result, RedirectAttributes redirectAttributes) {
    ...
    public String deleteContest(Model model, @RequestParam("id") Integer id, RedirectAttributes redirectAttributes) {
        try {
