...
public class ContestController extends BaseController {
	...
	@RequestMapping(produces = "text/plain", value = "/importicpcusers.json", method = RequestMethod.POST, headers = { "Accept=text/plain" })
	public @ResponseBody String importICPCUsers(
			Model model,
			Locale locale,
			@RequestParam("cid") Integer cid,
	...
	public @ResponseBody byte[] baylorXml(Model model, Locale locale,
