...
import cu.uci.coj.board.parsing.impl.WbTimusParser;
...
@WebAppConfiguration
public class WbTimusParserTest extends AbstractTransactionalJUnit4SpringContextTests {

	final static String CONTEST_NAME = "testname";
	final static String CONTEST_URL = "http://testurl.com";
	
	@Resource
	WbTimusParser wbTimusParser; 
	...
	@Test
	public void init() {
		Integer site = siteDAO.getSiteId( Config.getProperty("timus.name") );
	...
	public void checkParsing() {		
		try {
			...
			List<WbContest> list = wbTimusParser.parse();
