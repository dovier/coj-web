...
@WebAppConfiguration
public class WbUvaParserTest extends AbstractTransactionalJUnit4SpringContextTests {

	final static String CONTEST_NAME = "testname";
	final static String CONTEST_URL = "http://testurl.com";
	
	@Resource
	WbUvaParser wbUvaParser; 
	...
	@Test
	public void init() {
		Integer site = siteDAO.getSiteId( Config.getProperty("uva.name") );
	...
	public void checkParsing() {		
		try {
			...
			List<WbContest> list = wbUvaParser.parse();
