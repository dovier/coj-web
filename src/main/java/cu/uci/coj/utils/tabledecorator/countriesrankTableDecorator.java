 ...
 * @author Juanky
 */
public class countriesrankTableDecorator extends TableDecorator{
    ...
    /**
         ...
         */
        public countriesrankTableDecorator() {
                super();
        ...
        public String getPoints() {
                return this.decimal.format(((Country) this.getCurrentRowObject())
                                .getPoints());
        }
